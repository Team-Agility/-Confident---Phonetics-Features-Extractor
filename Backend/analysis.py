...
# sns.lmplot(x='mean_length_of_runs', y='confidence', data=df, aspect=2, height=6)
# plt.xlabel('Mean Length of Runs (words/s)')
# plt.ylabel('Confidence')
# plt.title('Confidence vs Mean Length of Runs')
# plt.show()

# sns.lmplot(x='silent_pauses_rate', y='confidence', data=df, aspect=2, height=6)
# plt.xlabel('Silent Pauses Rate')
# plt.ylabel('Confidence')
# plt.title('Confidence vs Silent Pauses Rate')
# plt.show()
...
plt.ylabel('Confidence')
plt.title('Confidence vs Short Term Energy')
